  ...
  const agents = [
    {
      ...
      specialization: 'Retail & Hospitality',
      experience: '8+ years',
      description: 'Specializing in retail and hospitality business sales with a proven track record of successful transactions.',
      achievements: ['50+ Successful Transactions', 'Top Broker 2022', 'Certified Business Intermediary']
    },
    {
      name: 'Michael Chen',
      ...
      experience: '12+ years',
      description: 'Expert in commercial property transactions with deep knowledge of the Melbourne market.',
      achievements: ['100M+ in Sales', 'Commercial Expert', 'Licensed Real Estate Agent']
    },
    {
      name: 'Emily Brown',
      title: 'Business Acquisition Specialist',
      image: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=600&q=80',
      location: 'Western Melbourne',
      specialization: 'Manufacturing & Industrial',
      experience: '6+ years',
      description: 'Focused on connecting buyers with profitable manufacturing and industrial businesses.',
      achievements: ['30+ Business Sales', 'Industry Specialist', 'M&A Certified']
    },
    {
      name: 'James Wilson',
      ...
      specialization: 'Franchise Operations',
      experience: '10+ years',
      description: 'Specialized in franchise sales and acquisitions across various industries.',
      achievements: ['40+ Franchise Transfers', 'Franchise Expert', 'Business Advisor']
    }
  ];
                    ...
                    <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1, mb: 3 }}>
                      {agent.achievements.map((achievement, idx) => (
                        ...
                        >
                          ...
                          <Typography variant="body2" sx={{ color: BRAND.blue }}>
                            {achievement}
                          </Typography>
                        </Box>
                      ))}
