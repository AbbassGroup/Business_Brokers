...
const IMAGES = {
  ...
  companies: {
    ...
    ndis: "/car/NDIS.png",
    degani: "/car/Degani Logo.webp",
    burgertory: "/car/Burgertory.png",
    jamaicaBlue: "/car/Jamaica Blue.png",
    rolld: "/car/Rolld.png",
...
const COMPANY_LINKS = [
  ...
  { url: "https://degani.com.au/", logo: IMAGES.companies.degani, alt: "Degani Cafe" },
  { url: "https://www.burgertory.com.au/", logo: IMAGES.companies.burgertory, alt: "Burgertory" },
  { url: "https://jamaicablue.com.au/", logo: IMAGES.companies.jamaicaBlue, alt: "Jamaica Blue" },
