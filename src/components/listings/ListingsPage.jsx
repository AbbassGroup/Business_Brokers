...
const CATEGORY_MAPPING = {
  ...
  'Commercial': ['commercial', 'accommodation', 'transport', 'automotive'],
...
<<<<<<< HEAD
      ...
      if (CATEGORY_MAPPING[selectedCategory]) {
        ...
        const categoryId = categories.find(cat => cat.name === listing.category)?.id;
        categoryMatch = CATEGORY_MAPPING[selectedCategory].includes(categoryId);
      } else {
        // If it's a detailed category, match exactly as before
